...
export default function Home() {
  ...
  const [amountOfQuestions, setAmountOfQuestions] = React.useState<number | null | undefined>(1);
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <h1 className='font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>QuizAI</h1>
        <p className='mb-4'>Create Quizes Now</p>
